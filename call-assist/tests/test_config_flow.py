...
class TestCallAssistConfigFlow:
    ...
    @pytest.mark.asyncio
    async def test_config_flow_with_valid_broker(self, broker_process, hass: HomeAssistant):
    ...
    @pytest.mark.asyncio
    async def test_config_flow_duplicate_configuration(self, broker_process, hass: HomeAssistant):
    ...
    @pytest.mark.asyncio
    async def test_config_flow_validation_logic(self, broker_process, hass: HomeAssistant):
