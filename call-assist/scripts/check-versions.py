...
def main():
    ...
    versions = [pyproject_grpc, pyproject_grpc_tools, broker_grpc, broker_grpc_tools, manifest_grpc, manifest_grpc_tools]
    ...
    if installed_grpc and not installed_grpc.startswith(expected_version):
        print(f'WARNING: Installed gRPC version ({installed_grpc}) does not match '
