...
class CallAssistGrpcClient:
    ...
    async def ensure_connection(self) -> bool:
        ...
        if self._connected and self.channel:
            try:
                ...
                await asyncio.wait_for(self.async_get_status(), timeout=5.0)
                return True
            except Exception:
                self._connected = False
    ...
    async def async_get_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            capabilities_response = await self.stub.get_system_capabilities(
                    ...
                    call_stations.append(
                        {
                            ...
                            "media_player_entity": entity.attributes.get(
                                "media_player_entity", ""
                            ),
                            "protocols": entity.attributes.get(
                                "protocols", "matrix"
                            ).split(","),
                    ...
                    contacts.append(
                        {
                            ...
                            "favorite": entity.attributes.get(
                                "favorite", "false"
                            ).lower()
                            == "true",
                            "available": entity.available,
            ...
            return {
                ...
                "broker_capabilities": {
                    "video_codecs": list(
                        capabilities_response.broker_capabilities.video_codecs
                    ),
                    "audio_codecs": list(
                        capabilities_response.broker_capabilities.audio_codecs
                    ),
    ...
    async def toggle_account_status(
        self, account_id: str, disable: bool = False
    ) -> bool:
